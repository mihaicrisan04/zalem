...
function CommandList({ className = "", ...props }: any) {
  return (
    <ScrollArea className={cn("max-h-[300px]", className)} viewportClassName="scroll-py-1">
      <CommandPrimitive.List data-slot="command-list" className="overflow-x-hidden" {...props} />
    </ScrollArea>
  );
}

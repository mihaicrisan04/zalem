...
function ContextMenuTrigger({ className = "", ...props }: any) {
  return (
...
function ContextMenuLabel({ className = "", inset = false, ...props }: any) {
  return (
...
function ContextMenuItem({ className = "", inset = false, variant = "default", ...props }: any) {
  return (
...
function ContextMenuSubTrigger({ className = "", inset = false, children = null, ...props }: any) {
  return (
...
function ContextMenuRadioItem({ className = "", children = null, ...props }: any) {
  return (

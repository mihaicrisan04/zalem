...
function MenubarItem({ className = "", inset = false, variant = "default", ...props }: any) {
  return (
    <DropdownMenuItem
...
function MenubarRadioItem({ className = "", children = null, ...props }: any) {
  return (
...
function MenubarLabel({ className = "", inset = false, ...props }: any) {
  return (
    <DropdownMenuLabel
...
function MenubarSubTrigger({ className = "", inset = false, ...props }: any) {
  return (
    <DropdownMenuSubTrigger

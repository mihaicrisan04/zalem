...
function NavigationMenu({ className = "", children = null, ...props }: any) {
  return (
...
function NavigationMenuTrigger({ className = "", children = null, ...props }: any) {
  return (
...
function NavigationMenuLink({ className = "", render, asChild, children, ...props }: any) {
  if (render) {
    return (

...
import {
  ...
  SheetPopup,
  SheetTitle,
} from "@zalem/ui/components/optics/sheet";
...
import { useIsMobile } from "@zalem/ui/hooks/use-mobile";
...
function SidebarTrigger({ className = "", onClick = undefined, ...props }: any) {
...
function SidebarInput({ className = "", ...props }: any) {
  return (
    <Input
...
function SidebarSeparator({ className = "", ...props }: any) {
  return (
    <Separator
...
function SidebarGroupLabel({ className = "", render = undefined, ...props }: any) {
  return useRender({
    defaultTagName: "div",
    props: mergeProps(
      {
...
function SidebarGroupAction({ className = "", render = undefined, ...props }: any) {
  return useRender({
...
function SidebarGroupContent({ className = "", ...props }: any) {
  return (
    <div
...
function SidebarMenuAction({ className, render, showOnHover = false, ...props }: any) {
  return useRender({
    defaultTagName: "button",
    props: mergeProps(
      {
...
function SidebarMenuBadge({ className, ...props }: any) {
  return (
    <div
...
function SidebarMenuSkeleton({ className, showIcon = false, ...props }: any) {
...
function SidebarMenuSubItem({ className, ...props }: any) {
  return (
    <li
...
function SidebarMenuSubButton({ render, size = "md", isActive = false, className, ...props }: any) {
  return useRender({
    defaultTagName: "a",
    props: mergeProps(
      {

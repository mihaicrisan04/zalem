...
import { Textarea } from "@zalem/ui/components/optics/textarea";

function InputGroup({ className = "", variant, ...props }: any) {
  return (
    <div
...
function InputGroupAddon({ className = "", align = "inline-start", ...props }: any) {
  return (
    <div
      role="group"
...
function InputGroupText({ className = "", ...props }: any) {
  return (
    <span
      className={cn(
...
function InputGroupInput({ className = "", ...props }: any) {
  return (
    <Input
...
function InputGroupTextarea({ className = "", ...props }: any) {
  return (
    <Textarea
      data-slot="input-group-control"
      className={cn(

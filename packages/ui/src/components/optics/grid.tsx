...
export const GridItem = ({
  ...
  const hasDecorations =
    decorationTopLeft || decorationTopRight || decorationBottomLeft || decorationBottomRight;
  ...
  return (
    ...
    >
      ...
      {decorationTopLeft && (
        <div className={cn("absolute -left-[1px] -top-[1px] z-10", span != 1 && "")}>
      ...
      {decorationTopRight && (
        <div className={cn("absolute -right-[0px] -top-[1px] z-10", span != 1 && "-right-[0px]")}>
          <div className="relative">
            <div className="bg-muted-foreground w-[1px] h-[21px] rounded-full absolute -top-2.5" />
            <div className="bg-muted-foreground w-[21px] h-[1px] rounded-full absolute -left-2.5" />
          </div>
      ...
      {decorationBottomRight && (
        <div
          className={cn("absolute -right-[0px] -bottom-[0px] z-10", span != 1 && "bottom-[1px]")}
        >
          <div className="relative">
            <div className="bg-muted-foreground w-[1px] h-[21px] rounded-full absolute -top-2.5" />
            <div className="bg-muted-foreground w-[21px] h-[1px] rounded-full absolute -left-2.5" />

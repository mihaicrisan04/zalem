...
similarity~\cite{Jaccard1912} measures how much two
...
``frequently bought together'' slot, with a minimum-support filter requiring
...
they are orthogonal~\cite{ManningIR2008}. For two vectors
$u, v \in \mathbb{R}^d$,
\begin{equation}
...
number by taking a weighted average across the five axes, the
standard weighted-sum method for multi-objective
ranking~\cite{MarlerArora2010}, used

            ...
            return (
              <div key={category._id} className="group relative">
                <Link
                  ...
                  className="text-muted-foreground hover:text-foreground hover:bg-accent inline-flex items-center rounded-md px-3 py-2 text-sm font-medium whitespace-nowrap transition-colors"
                >
                  {category.name}
                </Link>
